    ...
    children: [
      {
        ...
        name: 'Service List',
        meta: { title: 'Service List', icon: 'component', affix: false }
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/service/http'),
        name: 'Edit HTTP Service',
        meta: { title: 'Edit HTTP Service', icon: 'component', affix: false },
        hidden: true
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/service/tcp'),
        name: 'Edit TCP Service',
        meta: { title: 'Edit TCP Service', icon: 'component', affix: false },
        hidden: true
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/service/grpc'),
        name: 'Edit GRPC Service',
        meta: { title: 'Edit GRPC Service', icon: 'component', affix: false },
        hidden: true
      },
      {
